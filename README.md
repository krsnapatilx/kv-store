...
- Segmented log: Writes are appended to an active segment file (e.g. `1.segment`). When the segment reaches a target size the store rolls to a new segment file.
